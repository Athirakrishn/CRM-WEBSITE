(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,95057,(e,t,a)=>{"use strict";Object.defineProperty(a,"__esModule",{value:!0});var s={formatUrl:function(){return r},formatWithValidation:function(){return c},urlObjectKeys:function(){return l}};for(var o in s)Object.defineProperty(a,o,{enumerable:!0,get:s[o]});let i=e.r(90809)._(e.r(98183)),n=/https?|ftp|gopher|file/;function r(e){let{auth:t,hostname:a}=e,s=e.protocol||"",o=e.pathname||"",r=e.hash||"",l=e.query||"",c=!1;t=t?encodeURIComponent(t).replace(/%3A/i,":")+"@":"",e.host?c=t+e.host:a&&(c=t+(~a.indexOf(":")?`[${a}]`:a),e.port&&(c+=":"+e.port)),l&&"object"==typeof l&&(l=String(i.urlQueryToSearchParams(l)));let u=e.search||l&&`?${l}`||"";return s&&!s.endsWith(":")&&(s+=":"),e.slashes||(!s||n.test(s))&&!1!==c?(c="//"+(c||""),o&&"/"!==o[0]&&(o="/"+o)):c||(c=""),r&&"#"!==r[0]&&(r="#"+r),u&&"?"!==u[0]&&(u="?"+u),o=o.replace(/[?#]/g,encodeURIComponent),u=u.replace("#","%23"),`${s}${c}${o}${u}${r}`}let l=["auth","hash","host","hostname","href","path","pathname","port","protocol","query","search","slashes"];function c(e){return r(e)}},18581,(e,t,a)=>{"use strict";Object.defineProperty(a,"__esModule",{value:!0}),Object.defineProperty(a,"useMergedRef",{enumerable:!0,get:function(){return o}});let s=e.r(71645);function o(e,t){let a=(0,s.useRef)(null),o=(0,s.useRef)(null);return(0,s.useCallback)(s=>{if(null===s){let e=a.current;e&&(a.current=null,e());let t=o.current;t&&(o.current=null,t())}else e&&(a.current=i(e,s)),t&&(o.current=i(t,s))},[e,t])}function i(e,t){if("function"!=typeof e)return e.current=t,()=>{e.current=null};{let a=e(t);return"function"==typeof a?a:()=>e(null)}}("function"==typeof a.default||"object"==typeof a.default&&null!==a.default)&&void 0===a.default.__esModule&&(Object.defineProperty(a.default,"__esModule",{value:!0}),Object.assign(a.default,a),t.exports=a.default)},73668,(e,t,a)=>{"use strict";Object.defineProperty(a,"__esModule",{value:!0}),Object.defineProperty(a,"isLocalURL",{enumerable:!0,get:function(){return i}});let s=e.r(18967),o=e.r(52817);function i(e){if(!(0,s.isAbsoluteUrl)(e))return!0;try{let t=(0,s.getLocationOrigin)(),a=new URL(e,t);return a.origin===t&&(0,o.hasBasePath)(a.pathname)}catch(e){return!1}}},84508,(e,t,a)=>{"use strict";Object.defineProperty(a,"__esModule",{value:!0}),Object.defineProperty(a,"errorOnce",{enumerable:!0,get:function(){return s}});let s=e=>{}},22016,(e,t,a)=>{"use strict";Object.defineProperty(a,"__esModule",{value:!0});var s={default:function(){return y},useLinkStatus:function(){return w}};for(var o in s)Object.defineProperty(a,o,{enumerable:!0,get:s[o]});let i=e.r(90809),n=e.r(43476),r=i._(e.r(71645)),l=e.r(95057),c=e.r(8372),u=e.r(18581),p=e.r(18967),d=e.r(5550);e.r(33525);let h=e.r(88540),m=e.r(91949),g=e.r(73668),f=e.r(9396);function y(t){var a,s;let o,i,y,[w,b]=(0,r.useOptimistic)(m.IDLE_LINK_STATUS),C=(0,r.useRef)(null),{href:x,as:M,children:k,prefetch:R=null,passHref:S,replace:A,shallow:T,scroll:j,onClick:I,onMouseEnter:L,onTouchStart:q,legacyBehavior:N=!1,onNavigate:P,transitionTypes:B,ref:O,unstable_dynamicOnHover:z,...U}=t;o=k,N&&("string"==typeof o||"number"==typeof o)&&(o=(0,n.jsx)("a",{children:o}));let E=r.default.useContext(c.AppRouterContext),W=!1!==R,D=!1!==R?null===(s=R)||"auto"===s?f.FetchStrategy.PPR:f.FetchStrategy.Full:f.FetchStrategy.PPR,F="string"==typeof(a=M||x)?a:(0,l.formatUrl)(a);if(N){if(o?.$$typeof===Symbol.for("react.lazy"))throw Object.defineProperty(Error("`<Link legacyBehavior>` received a direct child that is either a Server Component, or JSX that was loaded with React.lazy(). This is not supported. Either remove legacyBehavior, or make the direct child a Client Component that renders the Link's `<a>` tag."),"__NEXT_ERROR_CODE",{value:"E863",enumerable:!1,configurable:!0});i=r.default.Children.only(o)}let _=N?i&&"object"==typeof i&&i.ref:O,K=r.default.useCallback(e=>(null!==E&&(C.current=(0,m.mountLinkInstance)(e,F,E,D,W,b)),()=>{C.current&&((0,m.unmountLinkForCurrentNavigation)(C.current),C.current=null),(0,m.unmountPrefetchableInstance)(e)}),[W,F,E,D,b]),H={ref:(0,u.useMergedRef)(K,_),onClick(t){N||"function"!=typeof I||I(t),N&&i.props&&"function"==typeof i.props.onClick&&i.props.onClick(t),!E||t.defaultPrevented||function(t,a,s,o,i,n,l){if("u">typeof window){let c,{nodeName:u}=t.currentTarget;if("A"===u.toUpperCase()&&((c=t.currentTarget.getAttribute("target"))&&"_self"!==c||t.metaKey||t.ctrlKey||t.shiftKey||t.altKey||t.nativeEvent&&2===t.nativeEvent.which)||t.currentTarget.hasAttribute("download"))return;if(!(0,g.isLocalURL)(a)){o&&(t.preventDefault(),location.replace(a));return}if(t.preventDefault(),n){let e=!1;if(n({preventDefault:()=>{e=!0}}),e)return}let{dispatchNavigateAction:p}=e.r(99781);r.default.startTransition(()=>{p(a,o?"replace":"push",!1===i?h.ScrollBehavior.NoScroll:h.ScrollBehavior.Default,s.current,l)})}}(t,F,C,A,j,P,B)},onMouseEnter(e){N||"function"!=typeof L||L(e),N&&i.props&&"function"==typeof i.props.onMouseEnter&&i.props.onMouseEnter(e),E&&W&&(0,m.onNavigationIntent)(e.currentTarget,!0===z)},onTouchStart:function(e){N||"function"!=typeof q||q(e),N&&i.props&&"function"==typeof i.props.onTouchStart&&i.props.onTouchStart(e),E&&W&&(0,m.onNavigationIntent)(e.currentTarget,!0===z)}};return(0,p.isAbsoluteUrl)(F)?H.href=F:N&&!S&&("a"!==i.type||"href"in i.props)||(H.href=(0,d.addBasePath)(F)),y=N?r.default.cloneElement(i,H):(0,n.jsx)("a",{...U,...H,children:o}),(0,n.jsx)(v.Provider,{value:w,children:y})}e.r(84508);let v=(0,r.createContext)(m.IDLE_LINK_STATUS),w=()=>(0,r.useContext)(v);("function"==typeof a.default||"object"==typeof a.default&&null!==a.default)&&void 0===a.default.__esModule&&(Object.defineProperty(a.default,"__esModule",{value:!0}),Object.assign(a.default,a),t.exports=a.default)},18566,(e,t,a)=>{t.exports=e.r(76562)},96661,5014,e=>{"use strict";let t=(...e)=>e.filter((e,t,a)=>!!e&&""!==e.trim()&&a.indexOf(e)===t).join(" ").trim();e.s(["mergeClasses",0,t],96661);var a=e.i(71645),s={xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"};let o=(0,a.createContext)({}),i=(0,a.forwardRef)(({color:e,size:i,strokeWidth:n,absoluteStrokeWidth:r,className:l="",children:c,iconNode:u,...p},d)=>{let{size:h=24,strokeWidth:m=2,absoluteStrokeWidth:g=!1,color:f="currentColor",className:y=""}=(0,a.useContext)(o)??{},v=r??g?24*Number(n??m)/Number(i??h):n??m;return(0,a.createElement)("svg",{ref:d,...s,width:i??h??s.width,height:i??h??s.height,stroke:e??f,strokeWidth:v,className:t("lucide",y,l),...!c&&!(e=>{for(let t in e)if(t.startsWith("aria-")||"role"===t||"title"===t)return!0;return!1})(p)&&{"aria-hidden":"true"},...p},[...u.map(([e,t])=>(0,a.createElement)(e,t)),...Array.isArray(c)?c:[c]])});e.s(["default",0,i],5014)},56420,e=>{"use strict";var t=e.i(71645),a=e.i(96661);let s=e=>{let t=e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,a)=>a?a.toUpperCase():t.toLowerCase());return t.charAt(0).toUpperCase()+t.slice(1)};var o=e.i(5014);e.s(["default",0,(e,i)=>{let n=(0,t.forwardRef)(({className:n,...r},l)=>(0,t.createElement)(o.default,{ref:l,iconNode:i,className:(0,a.mergeClasses)(`lucide-${s(e).replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase()}`,`lucide-${e}`,n),...r}));return n.displayName=s(e),n}],56420)},93583,e=>{"use strict";let t=(0,e.i(56420).default)("menu",[["path",{d:"M4 5h16",key:"1tepv9"}],["path",{d:"M4 12h16",key:"1lakjw"}],["path",{d:"M4 19h16",key:"1djgab"}]]);e.s(["Menu",0,t],93583)},63676,e=>{"use strict";let t=(0,e.i(56420).default)("x",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]);e.s(["X",0,t],63676)},16619,e=>{"use strict";var t=e.i(43476),a=e.i(71645),s=e.i(22016),o=e.i(18566),i=e.i(93583),n=e.i(63676);e.s(["default",0,function(){let[e,r]=(0,a.useState)(!1),[l,c]=(0,a.useState)(!1),u=(0,o.usePathname)();(0,a.useEffect)(()=>{let e=()=>{c(window.scrollY>20)};return window.addEventListener("scroll",e),()=>window.removeEventListener("scroll",e)},[]);let p=[{name:"Interactive Sandbox",path:"/"},{name:"Workflow Redesign",path:"/workflow-redesign"},{name:"Case Studies",path:"/case-studies"},{name:"ROI Calculator",path:"/roi-calculator"},{name:"Why LumeoCRM",path:"/comparison"},{name:"Blog",path:"/blog"}];return(0,t.jsx)("header",{className:`sticky top-0 w-full z-50 transition-all duration-300 ${l?"bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-100 py-3":"bg-white py-5"}`,children:(0,t.jsxs)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:[(0,t.jsxs)("div",{className:"flex justify-between items-center",children:[(0,t.jsx)(s.default,{href:"/",className:"flex items-center gap-3 group shrink-0",children:(0,t.jsx)("img",{src:"/logo.png",alt:"Logo",className:"h-10 w-auto"})}),(0,t.jsx)("button",{suppressHydrationWarning:!0,className:"lg:hidden text-gray-500 hover:text-brand-orange transition-colors focus:outline-none p-2",onClick:()=>r(!e),children:e?(0,t.jsx)(n.X,{className:"w-6 h-6"}):(0,t.jsx)(i.Menu,{className:"w-6 h-6"})}),(0,t.jsx)("nav",{className:"hidden lg:flex items-center gap-8",children:p.map(e=>(0,t.jsxs)(s.default,{href:e.path,className:`text-sm font-medium transition-all duration-200 relative group py-2 ${u===e.path?"text-brand-orange":"text-gray-600 hover:text-brand-orange"}`,children:[e.name,(0,t.jsx)("span",{className:`absolute bottom-0 left-0 w-full h-0.5 bg-brand-orange transform origin-left transition-transform duration-300 ${u===e.path?"scale-x-100":"scale-x-0 group-hover:scale-x-100"}`})]},e.name))}),(0,t.jsx)("div",{className:"hidden lg:flex items-center shrink-0",children:(0,t.jsx)(s.default,{href:"/contact",className:"text-sm font-semibold text-white bg-brand-orange hover:bg-brand-orange-hover px-5 py-2.5 rounded-md transition-colors",children:"Contact Sales"})})]}),(0,t.jsx)("div",{className:`lg:hidden overflow-hidden transition-all duration-300 ease-in-out ${e?"max-h-96 opacity-100 mt-4":"max-h-0 opacity-0"}`,children:(0,t.jsxs)("nav",{className:"flex flex-col gap-2 py-4 border-t border-gray-100",children:[p.map(e=>(0,t.jsx)(s.default,{href:e.path,onClick:()=>r(!1),className:`text-base font-medium px-4 py-3 rounded-lg transition-colors ${u===e.path?"bg-orange-50 text-brand-orange":"text-gray-600 hover:bg-gray-50 hover:text-brand-orange"}`,children:e.name},e.name)),(0,t.jsx)(s.default,{href:"/contact",onClick:()=>r(!1),className:"text-base font-medium text-white bg-brand-orange hover:bg-brand-orange-hover px-4 py-3 rounded-lg transition-colors mt-2 text-center",children:"Contact Sales"})]})})]})})}])},46227,e=>{"use strict";var t=e.i(43476);e.i(71645);var a=e.i(22016),s=e.i(16619);let o=[{id:"1",slug:"article-1",title:"What is CRM Software? A Complete Guide for Modern Businesses",excerpt:"Learn what CRM software is, its key features, benefits, and how it helps businesses of all sizes improve sales and customer relationships.",date:"Aug 07, 2026",author:"Product Team",imageUrl:"https://images.unsplash.com/photo-1551434678-e076c223a692?w=1200&q=80",category:"Product Update",content:`
    ...
    `},{id:"3",slug:"article-3",title:"Maximizing ROI: Best Practices for Implementing CRM",excerpt:"Learn the key strategies for a successful CRM implementation that guarantees maximum return on investment for your enterprise.",date:"Jul 12, 2026",author:"Customer Success",imageUrl:"https://images.unsplash.com/photo-1553877522-43269d4ea984?w=1200&q=80",category:"Best Practices",content:`
      ...
      <h2>2. Prioritize User Adoption</h2>
    ...
    `},{id:"12",slug:"article-12",title:"Why Small Businesses Outgrow Spreadsheets: The Shift to CRM",excerpt:"Still managing your clients and leads with Excel or Google Sheets? Discover the warning signs and why switching to CRM unlocks scalable growth.",date:"Jan 28, 2026",author:"Growth Advisory",imageUrl:"https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&q=80",category:"Business Growth",content:`
    ...
    `},{id:"13",slug:"article-13",title:"Mastering the Sales Pipeline: Stages, Metrics, and Best Practices",excerpt:"A structured sales pipeline turns unpredictable revenue into a repeatable machine. Learn how to design stages, track bottlenecks, and forecast accurately.",date:"Jan 15, 2026",author:"Revenue Operations",imageUrl:"https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=1200&q=80",category:"Strategy",content:`
    ...
    `},{id:"14",slug:"article-14",title:"Automated Invoicing & Quotations: How to Cut Sales Admin Time in Half",excerpt:"Manual quote generation and delayed invoicing stall deal momentum. Learn how built-in CRM billing features accelerate the quote-to-cash cycle.",date:"Dec 30, 2025",author:"Finance & Operations",imageUrl:"https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=1200&q=80",category:"Productivity",content:`
      <p>Sales representatives are hired to build relationships and close deals. Yet, studies show that reps spend up to 65% of their working hours on administrative tasks—such as drafting quotes in Word, calculating taxes in spreadsheets, and chasing overdue invoices.</p>
      <h2>The Dangers of Disconnected Billing</h2>
      <p>When quotations are prepared outside the CRM, pricing inconsistencies crop up, approval workflows stall, and finance teams struggle to reconcile deal sizes against actual invoices.</p>
      <h2>How Built-in CRM Quotations & Invoicing Streamlines Operations</h2>
      <ul>
        <li><strong>Pre-configured Product Catalogs:</strong> Reps can select products, quantities, and discount rates with automatic tax and currency calculations.</li>
        <li><strong>One-Click PDF Generation:</strong> Produce beautiful, branded proposals that can be sent to clients via email or WhatsApp in seconds.</li>
        <li><strong>Instant Conversion to Invoice:</strong> When a deal is marked "Won," the quotation automatically turns into a formal invoice with payment milestones.</li>
        <li><strong>Automated Payment Reminders:</strong> Set up friendly, automated reminder messages before and on invoice due dates to reduce DSO (Days Sales Outstanding).</li>
      </ul>
      <p>Eliminate repetitive manual entry and give your team the bandwidth to focus on revenue-generating conversations.</p>
