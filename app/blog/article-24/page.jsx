...
export const metadata = {
  ...
  description:
    'Learn how CRM software boosts customer retention, improves client loyalty, automates renewal follow-ups, and maximizes customer lifetime value for businesses in Kerala.',
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'article-24');
