...
export const metadata = {
  ...
  description:
    'Discover how mobile CRM empowers field sales teams and business owners in Kerala to access customer data, update deals, log calls, and close sales anywhere, anytime.',
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'article-22');
