...
export const metadata = {
  ...
  description:
    'A practical step-by-step roadmap for implementing CRM software successfully in your business, avoiding common adoption pitfalls, and training your team in Kerala.',
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'article-25');
