...
export const metadata = {
  ...
  description:
    'Understand how CRM analytics and reports help business owners and managers in Kerala measure lead conversions, pipeline health, team productivity, and revenue forecasts.',
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'article-23');
