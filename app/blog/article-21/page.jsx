...
export const metadata = {
  ...
  description:
    'Learn how CRM automation reduces manual work, automates lead assignment, schedules follow-ups, and streamlines sales operations for growing businesses in Kerala.',
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'article-21');
