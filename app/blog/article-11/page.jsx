...
export const metadata = {
  ...
  description:
    'Finding the Best CRM Software in Kerala is not only about choosing the software with the lowest price. Learn how to choose the right CRM based on features, usability, support, and overall value.',
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'article-11');
